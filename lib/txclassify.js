...
async function fetchClassifiedTransactions(wallet, untilSignature) {
  ...
  // Le reseau emet desormais des transactions de version 1. Plafonner a 0 fait
  // echouer TOUT le lot, donc la detection des flux externes avec.
  //
  // BUG CONNU, NON RESOLU : @solana/web3.js 1.95.3 ne sait pas non plus
  // deserialiser la version 1 ("At path: version -- Expected the value"). Les
  // deux bornes echouent donc aujourd'hui et la detection des flux est inactive
  // en production. Correction a faire : parsing tolerant signature par
  // signature, ou montee de version de la bibliotheque.
